...
model = tf.keras.models.load_model('model-gpu-rnn-1m-huh-2')
...
def predict():
    ...
    columns_to_normalize = [ 'volume_obv', 'volume_cmf', 
       'volatility_dcw', 'volatility_dcp', 'volatility_atr', 'volatility_ui',
       'trend_sma_slow', 'trend_ema_fast', 'trend_ema_slow',
       'trend_psar_down', 'trend_psar_up_indicator',
       'trend_psar_down_indicator', 'momentum_rsi', 'momentum_stoch_rsi',
       'momentum_stoch_rsi_k', 'momentum_stoch_rsi_d', 
       'momentum_uo', 
       'momentum_ao', 
       'momentum_ppo_hist', 
       'momentum_pvo_hist', 
    ...
    input_data = data2.T.reshape(1, lookbacks, len(columns_to_normalize))
