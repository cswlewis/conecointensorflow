...
class TickerData1s:
    def __init__(self):
        all_files = ["c:/Projects/ConeCoin.Tensorflow/BTCFDUSD-15s-2024-01.csv"]
        # all_files = [
        ...
        # #                  "c:/Projects/ConeCoin.Tensorflow/BTCFDUSD-1m-2023-09.csv",
        # #                  "c:/Projects/ConeCoin.Tensorflow/BTCFDUSD-1m-2023-10.csv",
        # #                  "c:/Projects/ConeCoin.Tensorflow/BTCFDUSD-1m-2023-11.csv",
        # #                  "c:/Projects/ConeCoin.Tensorflow/BTCFDUSD-1m-2023-12.csv",
        #                  "c:/Projects/ConeCoin.Tensorflow/BTCFDUSD-1m-2024-01.csv"
        #                  ] #last file includes 02/03/04 of 2023


        self.df = pd.concat((pd.read_csv(f, header=0) for f in all_files), ignore_index=True)
